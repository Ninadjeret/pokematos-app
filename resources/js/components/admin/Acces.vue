  ...
  <div>
    ...
    <div class="settings-section">
      ...
      <div class="setting">
        ...
        <p
          class="description"
        >Par défaut, tous les utilisateurs "administrateur" sur Discord sont administrateur de la map. Vous pouvez également ajouter d'autres roles comme administrateurs</p>
  ...
  methods: {
    fetch() {
      axios
        ...
        .then(res => {
          if (res.data.map_access_rule)
            this.map_access_rule = res.data.map_access_rule;
          if (res.data.map_access_roles)
            this.map_access_roles = res.data.map_access_roles;
          if (res.data.map_access_admin_roles)
            this.map_access_admin_roles = res.data.map_access_admin_roles;
          if (res.data.map_access_moderation_roles)
            this.map_access_moderation_roles =
              res.data.map_access_moderation_roles;
          if (res.data.access_moderation_permissions)
            this.access_moderation_permissions =
              res.data.access_moderation_permissions;
        })
        .catch(err => {
          //No error
        });
