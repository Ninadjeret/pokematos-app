...
class Helpers
{
    ...
    public static function getPokemonFormFromName($name)
    {
        ...
        $forms = [
            ...
            'PLANT' => ['id' => '11', 'name' => 'Plante', 'florked' => '', 'shuffle' => ''],
            'SANDY' => ['id' => '12', 'name' => 'Sable', 'florked' => '', 'shuffle' => ''],
            'TRASH' => ['id' => '13', 'name' => 'Déchet', 'florked' => '', 'shuffle' => ''],
            'RAINY' => ['id' => '13', 'name' => 'Pluie', 'florked' => '', 'shuffle' => ''],
            'SNOWY' => ['id' => '14', 'name' => 'Neige', 'florked' => '', 'shuffle' => ''],
            'SUNNY' => ['id' => '12', 'name' => 'Soleil', 'florked' => '', 'shuffle' => ''],
