...
class UserController extends Controller
{
    ...
    public function createConnector(Request $request, Guild $guild)
    {
        ...
        $connector = Connector::create([
            ...
            'filter_ex_type' => (isset($request->filter_ex_type)) ? $request->filter_ex_type : 'none',
    ...
    public function updateConnector(Request $request, Guild $guild, Connector $connector)
    {
        ...
        $connector->update([
            ...
            'filter_ex_type' => (isset($request->filter_ex_type)) ? $request->filter_ex_type : $connector->filter_ex_type,
